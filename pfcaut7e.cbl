...
*kl20170503 - G.03.00 - Neue Module
* EMV-Verarbeitung
?SEARCH  =WISO300
?SEARCH  =WISO310
?SEARCH  =WISO400
* Fuer Bearbeitung FREHEADER
?SEARCH  =WFREH07
*kl20170503 - G.03.00 - Ende
...
*G.03.14 - Modul für Zusammenstellung ZP-VERKAUF
?SEARCH =ZPVERK
*G.03.14 - Ende

*kl20160321 - G.02.01 - Pruefmodul BIN-Sperre
?SEARCH  =PFCBNS7
*kl20160321 - G.02.01 - Ende
...
*-------|----------|-----|-------------------------------------------*
*G.04.05|2019-02-11| kus | R7-471:
*       |          |     | - Neu Kompilierung für Modul PFCBNS7
*-------|----------|-----|--------------------------------------------------*
*G.04.04|2018-12-17| das | R7-435:
*       |          |     | - Keine VUNR Sonderlocke für BP
*-------|----------|-----|-------------------------------------------*
*G.04.03|2018-12-05| das | R7-424:
...
*       |          |     | (ZP-VERKAUF Modul)
*-------|----------|-----|-------------------------------------------*
*G.03.15|2018-04-30| kus | F1ICC-103:
*       |          |     | - AS BMP 12 fuellen mit ZP vom Terminal
*       |          |     |   dafuer ZP-VERKAUF verwenden (ist Kombi
*       |          |     |   aus Terminal BMP 12/13)
*-------|----------|-----|-------------------------------------------*
*G.03.14|2018-04-04| kl  | R7-272:
*       |          |     | Optimierung Zugriff / Laden FCPARAM
*       |          |     | (CARDID = 0 oder X - Vorrang bei X)
*       |          | kus | IQ-15:
*       |          |     | - Feld 48-8 wieder rein bei Stiglechner
*       |          | kus | R7-301:
*       |          |     | - ZP-Verkauf ueber Modul =ZPVERK
*-------|----------|-----|-------------------------------------------*
*G.03.13|2018-03-22| kus | IQ-13:
*       |          |     | - Feld 48-39 mit Belegnr fuellen
*-------|----------|-----|-------------------------------------------*
*G.03.12|2018-03-05| kl  | Bei Chip-Transaktionen Kartenart = 211
*       |          |     | setzen; BASIS: G.03.10
*       |          |     | (DKVCHIP-21)
*-------|----------|-----|-------------------------------------------*
*G.03.11|2018-03-05| kl  | VERWORFEN: Falsche Implementierung R7-269
*-------|----------|-----|-------------------------------------------*
*G.03.10|2018-01-22| hkn | Neu: Stiglechner  Routkz = 24
*-------|----------|-----|-------------------------------------------*
*G.03.09|2018-01-09| kl  | Initialierung T-MAX in B000 optimiert     *
*-------|----------|-----|-------------------------------------------*
*G.03.08|2018-01-05| kl  | Speichertabelle fuer FCPARAM vergroessert *
*-------|----------|-----|-------------------------------------------*
*G.03.07|2018-01-04| hkn | R7-Version aus X-Version kopiert
*-------|----------|-----|-------------------------------------------*
*G.03.06|2017-11-17| kl  | TXILOG70.KZ-E2EE jetzt nicht mehr fix;
*       |          |     | aus INT-SCHNITTSTELLE-C.reserve1(1:2)
*       |          |     | JIRA: R7-238
*       |          |     |
*       |2017-11-17| hkn | POST70-Zugriff mit Prüfung auf
*       |          |     | MDNR/TSNR
*-------|----------|-----|---------------------------------------*
*G.03.05|2017-10-10| hkn |Rücknahme G.03.03
*-------|----------|-----|---------------------------------------*
*G.03.04|2017-09-28| hkn |Erfassung-CHIP: BMP14 und BMP 35
*       |          |     |müssen vorkommen
*-------|----------|-----|---------------------------------------*
*G.03.03|2017-08-21| hkn | Wenn die In-Message das BMP 23 enthält,
*       |          |     | dann muss das BMP 55 das TAG 5F34
*       |          |     | enthalten
*-------|----------|-----|---------------------------------------*
*G.03.02|2017-05-24| kus | - Anpassung TXILOG70 TRANS-ART bei Chip
*-------|----------|-----|---------------------------------------*
*G.03.01|2017-05-19| kl  | - VUNR nur dann aus TSKART40, falls
*       |          |     |   nicht in IMSG-42 (TS-Nachricht)
*-------|----------|-----|---------------------------------------*
*G.03.01|2017-05-05| kl  | - Chipkartenverarbeitung integriert
*       |          |     |   (STIP hier nicht möglich)
*       |          |     | - MEMLOG-Key jetzt wieder komplettes
*       |          |     |   BMP 59 (statt Teilstring aus BMP 59)
*-------|----------|-----|---------------------------------------*
*G.03.00|2017-05-05| kl  | - Chipkartenverarbeitung integriert
*       |          |     |   (STIP hier nicht möglich)
*       |          |     | - MEMLOG-Key jetzt wieder komplettes
*       |          |     |   BMP 59 (statt Teilstring aus BMP 59)
*-------|----------|-----|---------------------------------------*
*-------|----------|-----|---------------------------------------*
*G.02.31|2017-04-06| hkn | POST70: Update pro TRX
*-------|----------|-----|---------------------------------------*
*G.02.30|2017-03-15| hkn | Anpassung MAC mit doppelten Schlüsseln
*-------|----------|-----|---------------------------------------*
*G.02.29|2017-02-02| hkn | FCPARM durch FCPARAM ersetzt
*-------|----------|-----|---------------------------------------*
*G.02.28|2016-12-29| HJO | Modul WSY7066 erneuert: In TND-Sonder-
*       |          |     | behandlung TND/R Karte integriert
*-------|----------|-----|---------------------------------------*
*G.02.27|2016-12-01| kl  | Grundsaetzliche Aenderung im BIN-
*       |          |     | sperrenmodul PFCBIN7 - Neu gebunden
*-------|----------|-----|---------------------------------------*
*G.02.26|2016-11-23| hkn | Stand in Verarbeiung: Auswertung
*       |          |     | LTG gleich Null oder 98
*       |          |     | WSYS930: Setzt ROUT-ASERR
*       |          |     | LTG = 0,98 oder 99
*       |          |     | TUEAS: Ermitteln LTG = 0 oder 98,
*       |          |     | dann STIP-Verarbeitung
*-------|----------|-----|---------------------------------------*
*G.02.25|2016-11-16| hkn | TND: PAC - BMP 52 ohne Prüfziffer,
*       |          |     | somit 12 Stellen, anstatt 13 Stellen
*-------|----------|-----|---------------------------------------*
*G.02.24|2016-11-08| hkn | Übersetzung wg. Änderung DUKPT
*-------|----------|-----|---------------------------------------*
*G.02.23|2016-11-07| hkn | EUROWAG: Sicherheitsverfahren auch
*       |          |     | wenn kein PAC in TS-Anfrage vorhanden
*-------|----------|-----|---------------------------------------*
*G.02.22|2016-11-07| hkn | Übersetzung wg. Änderung DUKPT
*-------|----------|-----|---------------------------------------*
*G.02.21|2016-11-02| hkn | Eurowag/Logpay/TND in 1200 - keine
*       |          |     | Geodaten schicken ( BMP 48.41 = 0 )
*-------|----------|-----|---------------------------------------*
*G.02.20|2016-11-01| hkn | Übersetzung wg. Änderung DUKPT
*       |          |     | Schlüssel
*-------|----------|-----|---------------------------------------*
*G.02.19|2016-10-30| hkn | Korrektur: Fehlerbeh. nach Inhalts-
*       |          |     | Fehler vom Artikelmapper
*-------|----------|-----|---------------------------------------*
*G.02.18|2016-09-29| hkn | EUROWAG: PAC Umschlüssen und Bilden
*       |          |     | mit DUKPT-Verfahren
*-------|----------|-----|---------------------------------------*
*G.02.18|2016-09-29| hkn | EUROWAG: PAC Umschlüssen und Bilden
*       |          |     | mit DUKPT-Verfahren
*-------|----------|-----|---------------------------------------*
*G.02.17|2016-09-21| hkn | Neu: LogPay mit Routkz = 23
*-------|----------|-----|---------------------------------------*
*G.02.16|2016-09-13| hkn |D310-TOTAL: Keine spezielle
*       |          |     |Bearbeitung BMP 42 - VUNR
*-------|----------|-----|---------------------------------------*
*G.02.15|2016-08-16| hkn |D314-BP: Macbildung - W66-DEFAULT
*-------|----------|-----|---------------------------------------*
*G.02.14|2016-08-02| hkn | Neu: Eurowag mit Routkz = 22
*-------|----------|-----|---------------------------------------*
*G.02.13|2016-08-01| hkn | POST70.TERMTYP = SPACES, dann Fehler
*       |          |     | und AC = 45 zurück an das Terminal
*-------|----------|-----|---------------------------------------*
*G.02.12|2016-07-27| hkn | D314-00 - BMP42: Länge korrigiert
*       |          |     |           BMP48 Default eingesetzt
*-------|----------|-----|---------------------------------------*
*G.02.11|2016-07-26| hkn | Rücknahme G.02.11 und G.02.10
*-------|----------|-----|---------------------------------------*
*G.02.10|2016-07-25| hkn | D305-AVIA: GEO-Daten (48.41) hexen,
*       |          |     | da diese in diesem Formant weiter
*       |          |     | verarbeteit werden (siehe ASAVA0E)
*-------|----------|-----|---------------------------------------*
*G.02.09|2016-07-05| hkn | Prüfung leere Artikelmenge in BMP 63
*       |          |     | verbessert
*       |          |     | AS-Kürzel nach AMP-FORMAT
*-------|----------|-----|---------------------------------------*
*G.02.08|2016-05-19| hkn | E100-FEP-ANTWORT: Prüfung MAC-Bilden
*       |          |     | verbessert
*-------|----------|-----|---------------------------------------*
*G.02.07|2016-05-17| kl  | BMP 59 Anpassungen:
*       |          |     |
*       |          |     | - jetzt Release+Applikation+ASTRACENR
*       |          |     |   (erstmal SHELL-Prototype)
*-------|----------|-----|---------------------------------------*
*G.02.06|2016-05-02| hkn |Leitungsprüfung angepasst,
*       |          |     |da die Leitung unter M150-CALL-WSYS930
*       |          |     |bereits geprüft und für DKV kein
*       |          |     |Fehlerausgang mit AC = 91, wegen STIP-
*       |          |     |Verarbeitung
*-------|----------|-----|---------------------------------------*
*G.02.01|2016-03-21| kl  |Erweiterung um konfigurierbare BIN-
*       |          |     |Sperre (aktivierbar ja Mandant/Cardid)
*-------|----------|-----|---------------------------------------*
*G.02.00|2016-03-17| hkn |Für Karten, die gegen WEAT-AS1
...
*-------|----------|-----|---------------------------------------*
*G.00.00|2015-02-13| BAH | Neuerstellung
*----------------------------------------------------------------*
*
* Programmbeschreibung
* --------------------
*
* Das Programm setzt Flottenkarten-Terminal-Autorisierungs-Anfragen
...
* definiert werden (z.B. PFCAUT7S-05 für Avia). Die Keys für das
...
*@Debug
*     SELECT DEBUGF      ASSIGN TO #DYNAMIC.
*@Debug
...
*--------------------------------------------------------------------*
 01          COMP-FELDER.
     ...
     05      REC-LEN             PIC  9(04) COMP VALUE ZEROS.
...
*--------------------------------------------------------------------*
 01          DISPLAY-FELDER.
     ...
     05      D-NUM4-ROUTKZ       PIC  9(04) VALUE ZEROS.
     05      D-NUM4-CARDID       PIC  9(04) VALUE ZEROS.
...
*--------------------------------------------------------------------*
 01          KONSTANTE-FELDER.
     05      K-MODUL             PIC X(08)          VALUE "PFCAUT7S".

**          ---> Pflichtfelder einer 1200-AS-Nachricht
     05      K-BYTEMAP-A1200      PIC X(64) VALUE
     "001100100011000000000101010000010000000011000001100000C000100010".
**             1         2         3         4         5         6
...
*----------------------------------------------------------------*
 01          SCHALTER.
     ...
     05      LTG-STATUS          PIC 9     VALUE ZERO.
          88 LTG-OK                        VALUE ZERO.
          88 LTG-NOK                       VALUE 1.
...
*kl20170504 - G.03.00 - Fuer MEMLOG-SWITCH-Ready
*            Hilfsbuffer fuer FREHEADER-Modul
 01          W-FH-BUFFER.
     05      FH-STRING           PIC X(256).
     05      FH-STRLEN           PIC S9(04) COMP.
*kl20170504 - G.03.00 - Ende
...
*kl20180404 - G.03.14 - Sieht gut aus, ist aber hier nicht angebracht
* 01          T-FCPARAM.
...
* 01          TD-KEY-DISP.
*       05    TD-KEY.
*         15  TD-ROUTKZ            PIC 9(04) VALUE ZEROS.
*         15  TD-CARDID            PIC 9(04) VALUE ZEROS.
*         15  TD-ISONTYP           PIC 9(04) VALUE ZEROS.
*         15  TD-KZ-MSG            PIC X(02).
*         15  TD-BMP               PIC 9(04) VALUE ZEROS.
*         15  TD-LFDNR             PIC 9(04) VALUE ZEROS.
*@Debug
...
*kl20180404 - G.03.14 - Zusätzlicher Searchkey für CARDID = 0
...
*kl20160321 - G.02.01 - Fuer Pruefung BIN-Sperre
**          ---> Schnittstelle zu SYSAWKZ
...
*kl20170504 - G.03.00 - Fuer BERTLV
...
*kl20160321 - G.02.01 - Fuer Kontrolle,
...
**  ---> Fehlerkonstellationen
     IF  FCPARAM-NOK
         ...
         EXIT SECTION
     END-IF
*kl20180105 - G.03.08 - T-TAB-MAX anthaelt Maximum
*     IF  C9-COUNT > T-MAX
...
**LTG-NOK = Stand-In-Prozess starten* Next-Server belegen
*G.02.06 - Anfang
     IF LTG-NOK
        MOVE "PFCSIP7S-12" TO IMSG-NEXTSERV
        EXIT SECTION
     END-IF
*G.02.06 - Ende
...
**Hier die AS-Nachricht zusammenbauen
...
*kl20170504 - G.03.00 - EMV-Verarbeitung

*    Fuer Formatpruefung schon mal BMP 22 uebernehmen (falls
*    vorhanden - Extra-Pruefung muss sein, da WSYS971 erst
*    später)
     IF  IMSG-TBMP(22) = 1
     AND IMSG-TPTR(22) > ZERO
     AND IMSG-TLEN(22) > ZERO
         MOVE IMSG-CF(IMSG-TPTR(22) + 1:2) TO W-ERFASSUNGS-ART
     ELSE
         INITIALIZE GEN-ERROR
         MOVE "BMP 22 (Erfassungsart fehlt in Nachricht" TO DATEN-BUFFER1
...
*G.03.14 - ZP-Verkauf ueber Modul ZPVERK
...
*                   = 2 ==> Fehler bei der Berechnung mit HCTIME
      ...
      MOVE TAL-TIME-N16                           TO ZPVERKAUF-FEPTALZEIT
...
**         ---> Spur 2 ist vorhanden
        ...
        UNSTRING W-SPUR2
                 delimited by "D" or "="
            INTO W-TEILSTRING (1)
                 delimiter       in W-DELIM (1)
                 count           in W-COUNT (1)
                 W-TEILSTRING (2)
                 delimiter       in W-DELIM (2)
                 count           in W-COUNT (2)
                 with pointer C4-PTR
                 tallying        in  C4-ANZ
        END-UNSTRING
...
**          ---> Fehler: weder BMP2/14 noch BMP35 vorhanden
            ...
            MOVE 30  TO W-AC
            MOVE 2201 TO ERROR-NR of GEN-ERROR
            MOVE "BMP2, 14, 35 nicht korrekt@" TO DATEN-BUFFER1
            PERFORM Z002-PROGERR
            EXIT SECTION
         END-IF
       END-IF
...
**  ---> Erfassungsart (BMP22)
*kl20170505 - G.03.00 - Das brauchen wir weiter oben
*     MOVE IMSG-CF(IMSG-TPTR(22) + 1:2) TO W-ERFASSUNGS-ART
*kl20170505 - G.03.00 - Ende
     ...
     or  (W-ERFASSUNGS-ART = "05" and not ERF-SPUR2)
         ...
         MOVE "BMP22 und BMP2,14,35,55 nicht korrekt" TO DATEN-BUFFER2
         PERFORM Z002-PROGERR
         EXIT SECTION
     END-IF

*kl20160321 - G.02.01 - BIN-Sperre
...
*G.02.09 - Anfang - BMP63 ohne Artikel
*        IF  P-HEX16(1:2) = "00"
**
         IF  IMSG-TLEN(63) = 33
*G.02.09 - Ende - BMP63 ohne Artikel
             MOVE 30   TO W-AC
             MOVE 2201 TO ERROR-NR of GEN-ERROR
...
*kl20170504 - G.03.00 - Ende
 ...
 C100-99.
      EXIT.
*kl20160321 - G.02.01 - Durchführen Prüfung BIN-Sperre
******************************************************************
...
**  ---> zunächst die BitMap auf die Pflichtfelder setzen
     ...
     MOVE K-BYTEMAP-A1200 TO W207-TBMP-O (1:64)

**  ---> Werte für Tabelle =FCPARAM
     MOVE 1200 TO S-ISONTYP
     MOVE "AS" TO S-KZ-MSG

     SET W207-IFSF TO TRUE
**  ---> Nachrichtentyp für Nachricht setzen
     MOVE 1200 TO W207-NTYPE
...
**  ---> BMP 12 - Lokalzeit (JJMMTThhmmss)
     MOVE 12 TO W207-XBMP
     MOVE 12 TO W207-XCOBLEN
*G.03.15 - Anhand ZP-VERKAUF (Kombination TS BMP 12/13) AS BMP 12 fuellen
...
**  ---> BMP 22 - Eingabeart
     ...
     MOVE 12 TO W207-XCOBLEN
*G.04.02 - Start von BMP 22 in FCPARAM definiert
...
**  ---> BMP 42 - VUNR
*kl20170519 - G.03.01 - VUNR nur dann aus TSKART40,
*                       falls nicht in TS-Anfrage
...
*                       (Inhalte bleiben stehen, Durchrouttn zum AS)
     IF  IMSG-TBMP(55) = 1
     AND IMSG-TPTR(55) > 0
     AND IMSG-TLEN(55) > 0
...
*kl20170504 - G.03.00 - Das komplette BMP 59 verwenden (Inhalt kann
*                       beliebig sein, da Antworter das gesamte BMP
*                       zum Lesen verwendet)
*kl20160517 - G.02.07 - Protoytping SHELL - Hier nur noch AS-TRACENR
*    IF VERF-SH
*       MOVE W-AS-TRACENR      TO MEM-LOGKEY
*    ELSE
...
*       END-STRING
*    END-IF
*    Inhalte in allgemein bzw. D307-SHELL belegt
     MOVE   IMSG-CF(IMSG-TPTR(59):IMSG-TLEN(59)) TO MEM-LOGKEY
*kl20160617 - G.02.07 - Ende
*kl20170504 - G.03.00 - Ende
...
*kl20160517 - G.02.07 - Sonderbehandlung BMP 59 (Erstmal als Prototyp,
*                       deshalb ein wenig "ungewohnt"
...
*G.04.04 VUNR jetzt aus TSKART40
...
*G.03.20 - Jetzt auch Subfeld 8, DEFAULT-Routine fuer 48 kann verwendet werden
     PERFORM E310-BMP48-DEFAULT
...
**  ---> und BMP48 aufbereiten
*G.03.13 - nicht mehr Default
*G.03.14 - ggf. auch Subfeld 8 einstellen
*     PERFORM E310-BMP48-DEFAULT
     MOVE ALL ZEROES TO W-BYTEMAP-48
*     MOVE "1"        TO W-BYTEMAP-48(4:1)
*     MOVE "1"        TO W-BYTEMAP-48(14:1)
...
** und jetzt Subfeld 4 Fixwert
     MOVE "1"        TO W-BYTEMAP-48(4:1)
     MOVE "0000000001" TO W-BUFFER (W-BUFFER-LEN + 1:)
     ADD 10 TO W-BUFFER-LEN

**  +++> und jetzt das Subfeld 8 (Kfz-Daten)
     IF  KFZ-YES AND W-48-LEN > ZERO
         MOVE W-BMP48-VAL (1:W-48-LEN) TO W-BUFFER (W-BUFFER-LEN + 1:)
         ADD W-48-LEN TO W-BUFFER-LEN
         MOVE "1"     TO W-BYTEMAP-48(8:1)
     END-IF

**  ---> Subfeld 14 und Fuehrende Nullen fuer 10 stelliges Feld 39 moven
     MOVE "1"        TO W-BYTEMAP-48(14:1)
     MOVE "1"        TO W-BYTEMAP-48(39:1)
     MOVE "03000000"       TO W-BUFFER(W-BUFFER-LEN + 1:)
     ADD 8 TO W-BUFFER-LEN

     MOVE W-ABWKZ(3:4)   TO W-BUFFER(W-BUFFER-LEN + 1:)
     ADD 4 TO W-BUFFER-LEN

**  ---> Bitmap erst am Ende erstellen, durch ggf. Subfeld 8
     MOVE  LOW-VALUE TO W-BITMAP
     ENTER TAL "WT^BY2BI" USING W-BITMAP W-BYTEMAP-48
     MOVE W-BITMAP TO W-BUFFER(1:8)
...
*G.02.26 - Anfang
******************************************************************
* Ermitteln Leitungsindex
******************************************************************
 D920-GET-LTGIND SECTION.
 D920-00.

      SET LTG-OK       TO TRUE
      MOVE ROUT-CARDID TO CARDID OF TUEAS
      MOVE ROUT-KZ     TO ROUTKZ OF TUEAS

      PERFORM S175-SELECT-TUEAS

      IF W-AC = ZEROS
         IF (LTGIND OF TUEAS =  0)
         OR (LTGIND OF TUEAS = 98)
             SET LTG-NOK TO TRUE
         ELSE
            MOVE 91     TO W-AC
            SET LTG-OK  TO TRUE
...
*kl20170504 - G.03.00 - Verarbeitung von Chipdaten
******************************************************************
...
*G.02.08 - Anfang Mac-Yes wird auch über FCPARAM gesetzt
*    IF  MAC-YES
**
     IF  IMSG-TBMP(64) = 1
*G.02.08 - Ende
...
*G.03.13 - nicht mehr benoetigt hier
**G.03.10 - Anfang
...
*kl20171117 - G.03.06 - Kommt jetzt in INT-SCHNITTSTELLE-C
*                       von der Drehscheibe
*       MOVE "V2"           TO KZ-E2EE        of TXILOG70
     MOVE IMSG-RESERVE1(1:2)   TO KZ-E2EE        of TXILOG70
*kl20171117 - G.03.06 - Ende
...
*     END-IF
*G.03.02 - TRANS-ART anpassen fuer Chip
...
*kl20170519 - G.03.01 - Die VUNR kann vom Terminal ODER
*                       aus TSKART40 kommen. Hier muss
*                       also IMMER das eingetragen werden,
*                       was ans AS geschickt wird
*     MOVE VUNR of TSKART40 TO VUNR         of TXILOG70
     MOVE IMSG-CF(IMSG-TPTR(42):IMSG-TLEN(42)) TO VUNR OF TXILOG70
*kl20170519 - G.03.01 - Ende
*G.03.14 - nicht mehr notwendig hier
*     MOVE W-ZP-VERKAUF   TO ZP-VERKAUF     of TXILOG70
*G.03.14 - Ende
     MOVE W-BMP07        TO AF-BMP07       of TXILOG70

*G.04.02 - Vorsichtshalber noch Abfragen, um Absturz zu verhindern
     IF TS-TBMP(63) = 1
...
*kl20170504 - G.03.00 - MEMLOG-Switch-Ready
...
*     (funktioniert, das IMSG-... EXTERNAL ist!)
...
******************************************************************
 ...
 M150-00.
     ...
     IF  ROUT-NOT-OK
         ...
         IF  ROUT-CMD-AS
             EVALUATE TRUE
*G.02.06 - Anfang Sonderbehandlung DKV-Stip-Verarbeitung
*            WHEN ROUT-ASERR
*            MOVE 91 TO W-AC
**
             WHEN ROUT-ASERR
                  IF W-ROUTKZ NOT = 12
                     MOVE 91 TO W-AC
                  ELSE
*STIP Weiterverarbeitung: Nur Zulaessig bei TRACK2
                     IF IMSG-TBMP(35) = 1
*G.02.26 - Anfang

*kl20170505 - G.03.00 - Bei EMV ist kein STIP möglich
                        IF IMSG-TBMP(55) = 1
                           MOVE 91 TO W-AC
                        ELSE
                           PERFORM D920-GET-LTGIND
                        END-IF
*                        PERFORM D920-GET-LTGIND
*kl20170505 - G.03.00 - Ende
...
******************************************************************
 ...
 P960-00.
     ...
     ELSE
         ...
         MOVE "Programm-Abbruch (PFCAUT7S)"   TO DATEN-BUFFER2
         PERFORM Z002-PROGERR
         SET PRG-ABBRUCH TO TRUE
         EXIT SECTION
     END-IF
...
**
     ...
     IF IMSG-NEXTSERV(1:6) = "PFCSIP"
        COMPUTE IMSG-SENDLEN = 4096 - 88
        MOVE 4096  TO REPLY-LAENGE
     ELSE
        MOVE IMSG-DATLEN TO IMSG-SENDLEN
        COMPUTE REPLY-LAENGE = IMSG-SENDLEN + 88
        MOVE K-MODUL     TO IMSG-MONNAME
...
*G.02.26 - Anfang
******************************************************************
* Select auf Tabelle TUEAS
******************************************************************
 S175-SELECT-TUEAS SECTION.
 S175-00.
     EXEC SQL
       SELECT   LTGIND
         INTO  :LTGIND OF TUEAS
         FROM  =TUEAS
        WHERE  ROUTKZ, CARDID
               =  :ROUTKZ  OF TUEAS
                 ,:CARDID  OF TUEAS
     ...
     EVALUATE SQLCODE OF SQLCA
         ...
         WHEN OTHER
              MOVE 2001 TO ERROR-NR OF GEN-ERROR
              MOVE ROUTKZ OF TUEAS TO D-NUM21
              MOVE CARDID OF TUEAS TO D-NUM20
         STRING "TUEAS@"
                "ROUTKZ/CID: "
                D-NUM21 "/"
                D-NUM20 "@"
...
*kl20160321 - G.02.01 - Soll BIN-Sperre geprueft werden?
******************************************************************
...
*   ASSIGN DEBUG
*     PERFORM U200-TIMESTAMP
*     STRING "$WSOFT."                       DELIMITED BY SIZE,
*            "WDKAY."                        DELIMITED BY SIZE,
*            "DB"                            DELIMITED BY SIZE,
*            TAL-MI OF TAL-TIME-D(2:1)       DELIMITED BY SIZE,
*            TAL-SS OF TAL-TIME-D            DELIMITED BY SIZE,
*            TAL-HS OF TAL-TIME-D            DELIMITED BY SIZE,
*     INTO ASS-FNAME
*     MOVE  ZERO             TO ASS-FSTATUS

**  ---> erst mal Sourcefile assignen
*     ENTER "COBOLASSIGN" USING  DEBUGF
*                                ASS-FNAME
*                         GIVING ASS-FSTATUS
...
*         DISPLAY " ---> Kein Debugfile erstellt <--- "
*         EXIT SECTION
*     ELSE
...
*        MOVE T-ROUTKZ(T-AKT-IND)       TO TD-ROUTKZ
*        MOVE T-CARDID(T-AKT-IND)       TO TD-CARDID
*        MOVE T-ISONTYP(T-AKT-IND)      TO TD-ISONTYP
*        MOVE T-KZ-MSG(T-AKT-IND)       TO TD-KZ-MSG
*        MOVE T-BMP(T-AKT-IND)          TO TD-BMP
*        MOVE T-LFDNR(T-AKT-IND)        TO TD-LFDNR
*        MOVE T-AKT-IND                 TO D-NUM4
...
*
*         ENTER TAL "String^Laenge"  USING DEBUG-RECORD, 80
*                                    GIVING REC-LEN
